...
namespace AGXTheme\Includes\Customizer;
	...
	private function print_customizer_upsell() {
		...
		if ( ! isset( $plugins['elementor/elementor.php'] ) ) {
			$customizer_content .= $this->get_customizer_upsell_html(
				__( 'Install Elementor', 'agx-theme' ),
				__( 'Create a cross-site Header and Footer using Elementor & AGX theme', 'agx-theme' ),
				wp_nonce_url(
					add_query_arg(
						[
				...
				__( 'Install &amp; Activate', 'agx-theme' ),
				get_template_directory_uri() . '/assets/images/go-pro.svg'
			);
		} elseif ( ! defined( 'ELEMENTOR_VERSION' ) ) {
			$customizer_content .= $this->get_customizer_upsell_html(
				__( 'Activate Elementor', 'agx-theme' ),
				__( 'Create a cross-site Header and Footer using Elementor & AGX theme', 'agx-theme' ),
			...
			$customizer_content .= $this->get_customizer_upsell_html(
				__( 'Update Elementor', 'agx-theme' ),
				__( 'You need Elementor version 3.1.0 or above to create a cross-site Header and Footer.', 'agx-theme' ),
			...
			$customizer_content .= $this->get_customizer_upsell_html(
				__( 'Set Your Header &amp; Footer', 'agx-theme' ),
				__( 'Create cross-site Header and Footer using Elementor & AGX theme', 'agx-theme' ),
				wp_nonce_url( 'post.php?post=' . get_option( 'elementor_active_kit' ) . '&action=elementor' ),
				__( 'Start Here', 'agx-theme' ),
				get_template_directory_uri() . '/assets/images/go-pro.svg'
			);
		}
